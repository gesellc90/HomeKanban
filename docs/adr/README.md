...
| [0005](0005-idempotente-entnahmebuchung.md) | Idempotente Entnahmebuchung über Unique-Index statt Vorab-Prüfung | teilweise ersetzt durch 0008 |
...
| [0008](0008-verbindung-je-anfrage.md) | Verbindung je Anfrage statt geteilter `app.state.db` | entschieden |
